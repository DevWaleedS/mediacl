...
import '../../index.css';
import image_1 from '../../assets/about/pic-1.jpg';
import image_2 from '../../assets/about/pic-2.jpg';
import image_3 from '../../assets/about/pic-3.jpg';

import animation_1 from '../../assets/about/animation-1.png';
import animation_2 from '../../assets/header/animation-2.png';
import animation_4 from '../../assets/header/animation-4.png';
import animation_5 from '../../assets/about/animation-4.png';
				...
				<div className='row align-items-center'>
					<div className='col-lg-6 mb-30'>
						<div className='about-images'>
							<ul>
								<li>
									<LazyLoadImage className='img-about1 img-fluid' src={image_1} alt='about one' effect='blur' />
								</li>
								<li>
									<LazyLoadImage className='img-about2 img-fluid' src={image_2} alt='about tow' effect='blur' />
								</li>
								<li>
									<LazyLoadImage className='img-about3 img-fluid' src={image_3} alt='about three' effect='blur' />
								</li>
								<li>
									<div className='experience'>
										<span>20</span>
										<span className='exp'>Year Experience</span>
									</div>
								</li>
							</ul>
						</div>
					...
					<div className='col-lg-6 mb-30'>
						<div className='about-text'>
							...
							<h2 className='about-heading'>The Great Place Of Medical Hospital Center</h2>
							...
							<div className='col-lg-6 col-sm-6 mb-30 mb-sm-20'>
								<div className='feature-container feature1'>
									<div className='feat-icon'>
										<span>
											<svg enableBackground='new 0 0 512 512' height='45' viewBox='0 0 512 512' width='45' xmlns='http://www.w3.org/2000/svg'>
						...
						<Link className='read-btn blue-btn ' to='about-us'>
							Read More
						</Link>
					</div>
				</div>
				<div className='animations'>
					<img className='about-animation-1 ' src={animation_1} alt='animation-1' />
					<img className='about-animation-2' src={animation_2} alt='animation-2' />
					<img className='about-animation-3' src={animation_2} alt='animation-2' />
					<img className='about-animation-4' src={animation_4} alt='animation-4' />
					<img className='about-animation-5' src={animation_5} alt='animation-5' />
				</div>
			</div>
		</section>
	);
