...
import animation_2 from '../../assets/services/animation-2.png';
	...
	return (
		<section className='services-section section-space'>
				...
				<div className='row align-items-center'>
					<div className='col-xl-4 col-lg-7 mb-30'>
						<div className='heading-row'>
							...
							<h2 className='heading'>We Cover A Big Variety Of Medical Services</h2>
						</div>
						<div className='content'>
							<p>We provide the special tips and advice’s of heath care treatment and high level of best.</p>
							<Link className='orange-btn blue-btn read-btn ' to='services'>
								All Services
							</Link>
						</div>
					</div>
						...
						>
							<SwiperSlide>
								<div className='feature-wrapper'>
									<div className='icon-box'>
										<div className='icon'>
											<svg enableBackground='new 0 0 512 512' height='65' viewBox='0 0 512 512' width='65' xmlns='http://www.w3.org/2000/svg'>
												<path
									...
									<div className='content-box'>
										<h3 className='icon-title'>Diagnostics</h3>
										<p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
										<Link className='view-more-btn ' to='service-detail'>
											View More
										</Link>
									</div>
								</div>
							...
							<SwiperSlide>
								<div className='feature-wrapper'>
									...
									<div className='content-box'>
										<h3 className='icon-title'>Treatment</h3>
										<p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
										<Link className='view-more-btn' to='service-detail'>
											View More
										</Link>
							...
							<SwiperSlide>
								<div className='feature-wrapper'>
									...
									<div className='content-box'>
										<h3 className='icon-title'>Surgery</h3>
										<p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
										<Link className='view-more-btn ' to='service-detail'>
											View More
										</Link>
							...
							<SwiperSlide>
								<div className='feature-wrapper'>
									...
									<div className='content-box'>
										<h3 className='icon-title'>Vaccine</h3>
										<p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
										<Link className='view-more-btn' to='service-detail'>
											View More
										</Link>
							...
							<SwiperSlide>
								<div className='feature-wrapper'>
									...
									<div className='content-box'>
										<h3 className='icon-title'>Emergency</h3>
										<p>Phasellus venenatis porta rhoncus. Integer et viverra felis.</p>
										<Link className='view-more-btn' to='service-detail'>
											View More
										</Link>
			...
			<div className='animations'>
				<img className='service-animation-1' src={animation_1} alt='animation-1' />
				<img className='service-animation-2' src={animation_2} alt='animation-2' />
				<img className='service-animation-3' src={animation_3} alt='animation-3' />
				<img className='service-animation-4' src={animation_4} alt='animation-4' />
			</div>
		</section>
	);
};
